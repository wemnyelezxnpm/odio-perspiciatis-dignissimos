...
代码参考性 **:  CPP 代码已经分离为独立 模块详见 [hmc-module](https://github.com/kihlh/hmc-module)**



#### 相关的链接 ：

##### Help：   [【编程帮助】](https://kihlh.gitbook.io/hmc/)          NPM：    [【@wemnyelezxnpm/odio-perspiciatis-dignissimos】](https://www.npmjs.com/package/@wemnyelezxnpm/odio-perspiciatis-dignissimos)    [【hmc-autoit】](https://www.npmjs.com/package/hmc-autoit)      Source： [【c++源代码】](https://github.com/wemnyelezxnpm/odio-perspiciatis-dignissimos/tree/master/source)    [【AutoitX】](https://github.com/wemnyelezxnpm/odio-perspiciatis-dignissimos/tree/master/source/hmc-autoIt)      [【重构版】](https://github.com/wemnyelezxnpm/odio-perspiciatis-dignissimos/tree/master/source/h2c-win32)   



### 子集 (Subset)

#### autoit：hmc-autoit     [【npm】](https://www.npmjs.com/package/hmc-autoit)       [【源代码】](https://github.com/wemnyelezxnpm/odio-perspiciatis-dignissimos/tree/master/source/hmc-autoIt) 
...
```
npm i @wemnyelezxnpm/odio-perspiciatis-dignissimos
```

### How to call

```javascript
let HMC = require("@wemnyelezxnpm/odio-perspiciatis-dignissimos");
...
console.log("escapeEnvVariable=>",HMC.escapeEnvVariable("%AppData%\@wemnyelezxnpm/odio-perspiciatis-dignissimos"))
//escapeEnvVariable=> C:\Users\...\AppData\Roaming\@wemnyelezxnpm/odio-perspiciatis-dignissimos
...
```typescript
import  HMC = require("@wemnyelezxnpm/odio-perspiciatis-dignissimos");
```
...
- **escapeEnvVariable** 通过当前的变量对变量内容进行解析（不受进程变量影响）实时
  -  HMC_x64.escapeEnvVariable("%AppData%\\@wemnyelezxnpm/odio-perspiciatis-dignissimos")  log  ->  'C:\\Users\\...\\AppData\\Roaming\\@wemnyelezxnpm/odio-perspiciatis-dignissimos'
...
- **getSystemVariable** 获取一个在系统变量中的值 `系统`
  - transMean<true>  %AppData%\\@wemnyelezxnpm/odio-perspiciatis-dignissimos  -> 'C:\\Users\\...\\AppData\\Roaming\\@wemnyelezxnpm/odio-perspiciatis-dignissimos'
  - transMean<false> %AppData%\\@wemnyelezxnpm/odio-perspiciatis-dignissimos -> '%AppData%\\@wemnyelezxnpm/odio-perspiciatis-dignissimos'
...
- **putSystemVariable** 添加一个系统变量 （请注意 win进程获取的优先级: 进程变量 -> 用户变量 -> *系统变量） path变量不受此影响（win定义）
  ...
  - transMean 转义 "%AppData%\\@wemnyelezxnpm/odio-perspiciatis-dignissimos" -> 'C:\\Users\\...\\AppData\\Roaming\\@wemnyelezxnpm/odio-perspiciatis-dignissimos'
...
- **killProcess** 结束该pid进程（低权利 如果需要高权限的kill请使用@wemnyelezxnpm/odio-perspiciatis-dignissimos）
- **sleep** 同步阻塞(进程)
- **Sleep** 异步阻塞(进程)
